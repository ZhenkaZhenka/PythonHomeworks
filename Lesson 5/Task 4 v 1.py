...
# Если введеный текст состоит только из букв, тогда можно будет сделать проверку на символ и сделать необходимое количество повторений для дешифровки,
# но если в веденном тексте будут присутвовать и буквы и цифры, то появится погрешность.
# Например:
#     Веденный текст VVVVVVVvvvggg зашифруется как 7V3v3g, 
#     но если введеный текст будет Vvvv22222BBB4444h, то зашифруется как 1V3v523B41h, и тут просто появится несколько вариантов для дешифровки.

# Поэтому я сделал более-менее универсальное решение
